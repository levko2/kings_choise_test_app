package levkovskiy.dev.testapp.customview
...
class CircularImageView @JvmOverloads constructor(
    ...
    private var colorFilter2: ColorFilter? = null
    ...
    private fun init(context: Context, attrs: AttributeSet?, defStyleAttr: Int) {
        ...
        if (attributes.getBoolean(R.styleable.CircularImageView_civ_shadow, false)) {
            ...
            val shadowGravityIntValue =
                attributes.getInteger(R.styleable.CircularImageView_civ_shadow_gravity, ShadowGravity.BOTTOM.value)
            shadowGravity = ShadowGravity.fromValue(
                shadowGravityIntValue
            )
        }
    ...
    override fun setColorFilter(colorFilter: ColorFilter) {
        ...
        drawable2 = null // To force re-update shader
        invalidate()
    }
